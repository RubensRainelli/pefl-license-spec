...
La **Personal and Educational Free License (PEFL)** è una licenza software personalizzata e a autore singolo, progettata per proteggere i progetti dall'utilizzo commerciale e aziendale non autorizzato. Offre un accesso gratuito al 100% per scopi personali, didattici, accademici e no-profit, richiedendo invece alle entità commerciali di ottenere un'autorizzazione scritta e di pagare una fee di licenza.
...
Seleziona la versione linguistica desiderata per il testo della licenza PEFL v1.0 e la documentazione:

| Lingua | Testo Ufficiale della Licenza | README Tradotto |
| :--- | :---: | :---: |
...
Se utilizzi agenti AI (come Cursor, GitHub Copilot, Gemini o ChatGPT) per scrivere o modificare codice nel tuo progetto, ti consigliamo di caricare nel loro contesto il file [AI_INSTRUCTIONS.md](../AI_INSTRUCTIONS.md).
...
Aggiungi il file [LICENSE](../LICENSE) (e/o una qualsiasi delle traduzioni localizzate) alla root directory del tuo repository. Aggiungi anche il file [NOTICE_IT](../templates/NOTICE_IT.md) per riassumere i termini.
...
No. La PEFL **non** è una licenza approvata dall'OSI (Open Source Initiative). Poiché impone restrizioni sull'uso commerciale, viene classificata come licenza "Source-Available" o "Fair-Code", simile alla JSON License, Commons Clause o alla Business Source License (BSL) di MariaDB.

### Perché le organizzazioni religiose sono escluse dall'Uso Privato?
Ai fini della PEFL, gli enti di culto e le organizzazioni religiose sono equiparati a Uso Aziendale. Ciò assicura che l'autore mantenga il pieno controllo sui termini di distribuição e utilizzo del software per queste entità, richiedendo un'autorizzazione scritta preliminare.

### Posso usare software PEFL sul mio computer aziendale per studio personale?
Sì. A condizione che l'uso sia strettamente confinato all'autoformazione personale o all'uso domestico, e que **non** contribuisca, supporti, o esegua flussi di lavoro professionali o aziendali della ditta.
